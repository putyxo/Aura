...
<head>
    ...
    <title>Editar Perfil - AURA</title>
    ...
    <style>
        * {
        ...
        /* Efectos adicionales para inputs con iconos */
        .form-group {
            position: relative;
        }
...
<body>
    <div class="container">
        ...
        <div class="edit-form">
            <h2>
                <i class="fas fa-user-edit"></i> Editar tu Perfil
            </h2>
            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="ubicacion" name="ubicacion" placeholder="Tu ciudad, país">
                </div>
