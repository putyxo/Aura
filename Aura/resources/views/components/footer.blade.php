{{-- resources/views/components/footer.blade.php (encapsulado) --}}
...
#rightPlayer .song-name{ font-size:20px; font-weight:700; margin-top:14px; color:var(--pl-fg); text-align:center }
#rightPlayer .song-autor{ font-size:14px; color:var(--pl-accent2); margin-top:4px }
...
#rightPlayer .seek{
  ...
  background:linear-gradient(to right,var(--pl-accent) 0%, var(--pl-accent2) 0%, var(--pl-line) 0%, var(--pl-line) 100%);
  cursor:pointer
}
#rightPlayer .seek::-webkit-slider-thumb{
  -webkit-appearance:none; width:16px; height:16px; border-radius:50%;
  background:linear-gradient(135deg,var(--pl-accent),var(--pl-accent2));
  box-shadow:0 0 12px var(--pl-glow); transition:transform .2s; position:relative; z-index:2
}
#rightPlayer .seek::-webkit-slider-thumb:hover{ transform:scale(1.25) }
...
#rightPlayer .controls button:hover{ transform:scale(1.2); color:var(--pl-accent2) }
#rightPlayer .controls .play-btn{
  width:64px; height:64px; border-radius:50%;
  background:linear-gradient(135deg,var(--pl-accent),var(--pl-accent2));
  color:#fff; font-size:26px; box-shadow:0 0 25px var(--pl-glow); transition:transform .25s, box-shadow .25s
}
...
#rightPlayer .icon-btn:hover{ color:var(--pl-accent2); transform:scale(1.2) rotate(-6deg) }

#rightPlayer .vol-range{
  -webkit-appearance:none; width:120px; height:6px; border-radius:999px;
  background:linear-gradient(to right,var(--pl-accent) 0%, var(--pl-accent2) 70%, #35354f 70%, #35354f 100%);
  cursor:pointer
}
...
#rightPlayer .play-list{ flex:1; background:var(--pl-bg-1); padding:16px; overflow-y:auto }
...
/* Modal de playlists dentro del player */
#rightPlayer .playlist-modal{ position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); width:auto; padding:0; background:transparent; pointer-events:none; z-index:var(--z-popup) }
#rightPlayer .playlist-modal[hidden]{ display:none }
#rightPlayer .playlist-modal-content{
  min-width:320px; max-width:420px; background:#191a2a; border:1px solid #2b2d46; border-radius:16px;
  padding:18px; color:#fff; pointer-events:auto; box-shadow:0 20px 60px rgba(0,0,0,.55)
}
...
#rightPlayer .playlist-modal-content li{ padding:8px 10px; border-radius:10px; cursor:pointer; transition:background .2s ease }
