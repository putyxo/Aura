...
<div class="app">
  <div class="with-sidebar">
    ...
    <!-- ROOT AISLADO -->
    <main id="axplRoot" class="axpl axpl-main" data-axpl-max-mb="5">
      <div class="axpl-shell">
        ...
        <section class="axpl-hero" aria-label="Tus Playlists">
          ...
          <div class="axpl-hero__row">
            <div class="axpl-hero__content">
              <div class="axpl-hero__icon"><i class="fa-solid fa-list-music"></i></div>
              <div>
        ...
        <!-- Toast -->
        @if(session('ok'))
          <div class="axpl-toast axpl-toast-ok" role="status" aria-live="polite">
